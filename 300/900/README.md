...
Following from the [Strategic Planning Management](https://github.com/vanHeemstraSystems/strategic-planning-management), the following table should be created and maintained at tactical level within the Agile Release Train (ART) for use at the [PI](https://github.com/vanHeemstraSystems/product-increment-planning-and-execution-management) report out:
